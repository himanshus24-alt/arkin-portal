...
(Secured Retail Lending = STLAP + Wheels).

Hierarchy & product view rules:
  - RM, ABM, RBM, ZH, BH  → product-specific (STLAP OR Wheels)
  - CXO / Central / Admin  → SRL (consolidated) with STLAP/Wheels toggle
